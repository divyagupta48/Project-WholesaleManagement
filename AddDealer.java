...
public class AddDealer extends BaseClass implements ActionListener
{
JButton add,cancel;
...
if(e.getSource()==cancel)
{
	...
	{JOptionPane.showMessageDialog(this,"Addition Cancelled !");
	setVisible(false);}
}
else if(e.getSource()==add)
{
	...
	{
	try {
       String s="insert into dealer"+" values('"+t1.getText()+"','"+t2.getText()+"','"+t3.getText()+"','"+t4.getText()+"','"+t5.getText()+"')";
